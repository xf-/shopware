...
class SnippetsToDbCommand extends ShopwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $sourceDir = $this->container->getParameter('kernel.root_dir') . DIRECTORY_SEPARATOR . $input->getOption('source');
        ...
        if ($input->getOption('include-plugins')) {
            ...
            $pluginSources = $this->container->getParameter('shopware.pluginSources');
